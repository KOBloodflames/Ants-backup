...
typedef struct {cell_type type; int owner; int bfs; int bfsvisited; int move; int squad; int soldier; int defender;} cell;
...
/*linked list*/
struct Node;
typedef struct Item{int id; int x; int y; ant_role role; direction lastmove; int water; int squad; int alive; int moving; int targetx; int targety; int routenr; char *route;} Item;
